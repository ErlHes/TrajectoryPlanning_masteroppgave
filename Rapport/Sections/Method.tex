...
and the column dimension c is dependant on the amount and shape of the obstacles.
%%
...
In the final version of the algorith, static obstacle constraints can be generated the following way:\newline
...
While iterating through the selected trajectory the scanlines are fairly easy to construct, but conducting the intersection check is actually very complicated. Luckily
