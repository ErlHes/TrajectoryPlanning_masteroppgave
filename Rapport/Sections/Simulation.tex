...
respect to COLREGs, and therefore a highly undesired behavior. Sadly the root of the problem is not easy to fix, by "leaning" the wrong way
...
\begin{figure}[!ht] %TODO: Skriv om bad prediction
    ...
    \end{subfigure}
    \caption{This is what can happen when the prediction does not match the actual trajectory of the \gls{Ts}s.}
...
\begin{figure}[!ht] %% Blocked Path event
    ...
    \end{subfigure}
    \hfill
    \caption{How the optimal path is calculated with lower speed when infeasibility is detected.}
...
\begin{figure}[!ht] %% WRAPTO2PI PROBLEMS
    ...
    \begin{subfigure}{0.80\textwidth}
        ...
        \caption{Here we see the heading reference and optimal values, at about k = 50, and again around 200 we can see that the heading reference experiences a discontinuous jump as it wraps
        from $\pi$ to $-\pi$.}
    \end{subfigure}
    \hfill
    \\
    ...
    \end{subfigure}
    \caption{Without proper course reference, this would sometimes happen.}
...
\begin{figure}[!ht] %% WRONG TURN
    ...
    \begin{subfigure}{0.80\textwidth}
        ...
        \caption{Meanwhile, the optimal trajectory is clearly a turn to starboard.}
    \end{subfigure}
    \hfill
