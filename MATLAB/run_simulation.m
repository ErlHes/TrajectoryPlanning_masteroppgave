...
if(parameters.system.make_video)
    ...
    video_filepos = strcat('C:\Users\erlen\Documents\GitHub\TrajectoryPlanning_masteroppgave\MATLAB\videoresults/');

    % create the video writer with 1 fps
    writerObj = VideoWriter( strcat(video_filepos, fig_filename,'_mid_level_period_07_geq_fig600.avi'));
    ...
    writerObj2 = VideoWriter( strcat(video_filepos, fig_filename,'_mid_level_period_07_geq_fig1.avi'));
    ...
    close(writerObj2);
        ...
        writerObj3 = VideoWriter( strcat(video_filepos, fig_filename,'_mid_level_period_07_geq_fig999.avi'));
