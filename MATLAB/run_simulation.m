...
if(parameters.system.make_video)
    ...
    writerObj = VideoWriter( strcat(video_filepos, fig_filename,'1105-3_fig600.avi'));
    ...
    writerObj2 = VideoWriter( strcat(video_filepos, fig_filename,'1105-3_fig1.avi'));
    ...
    close(writerObj2);
        ...
        writerObj3 = VideoWriter( strcat(video_filepos, fig_filename,'1105-3_fig999.avi'));
