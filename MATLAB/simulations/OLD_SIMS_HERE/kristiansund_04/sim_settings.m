settings = struct;
settings.t_sim = 600; % Simulation time in seconds
settings.dt = 0.1; %sample time in seconds
settings.time_steps = settings.t_sim/settings.dt;

settings.axis = [-500,300,50,1200];
% settings.axis = [-400,200,300,1100];
% settings.axis = [-300,150,500,1000];
...
settings.legend_position = [600,-450]';
