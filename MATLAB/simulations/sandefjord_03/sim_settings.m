settings = struct;
settings.t_sim = 580; % Simulation time in seconds
% settings.t_sim = 150; % Debubing time
settings.dt = 0.1; %sample time in seconds
settings.time_steps = settings.t_sim/settings.dt;


settings.axis = [0,1400,0,1230];
% settings.axis = [500,750,220,430]; % axis for debugung guidance at arrival

settings.gcf_position = [0,300,1200,1050];
...
settings.text_time_stamps_position = [350,800];
settings.delta_text = 35;
settings.delta_text_x = 150;
settings.text_lines_per_column = 5;
settings.vessel_scale = 4;

settings.legend_position = [100,1000]';
settings.legend_size = [170,170]';
